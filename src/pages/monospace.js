...
import FontJson from "../assets/monospace.json"
                        ...
                        {selectedFont.arr[0].map((variant) => {
                            return (
                                <div className="mr-12" key={variant}>
                                    ...
                                    <p className="text-purple-700 text-3xl" style={{fontFamily: [selectedFont.family, 'monospace'], fontWeight: variant, fontStyle: 'normal'}}>{selectedFont.family}</p>
                                </div>
                            )
                        })}
                    </div>
                    ...
                    <div className="flex flex-wrap justify-start">
                        {selectedFont.arr[1].length !== 0 && selectedFont.arr[1].map((variant) => {
                            return (
                                <div className="mr-12" key={variant}>
                                    <h4 className="text-2xl">{variant}</h4>
                                    <p className="text-purple-700 text-3xl" style={{fontFamily: [selectedFont.family, 'monospace'], fontWeight: variant, fontStyle: 'italic'}}>{selectedFont.family}</p>
                                </div>
                            )
                        })}
                    </div>
