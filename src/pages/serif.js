...
import FontJson from "../assets/serif.json"
        ...
        <main className="max-w-6xl w-4/5 mx-auto flex flex-col">
            <section className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12">
                <div>
                    ...
                    <p className="mt-2 text-purple-700 text-4xl" style={{fontFamily: [selectedFont.family, 'serif']}}>{selectedFont.family}</p>
                </div>
                        ...
                        {selectedFont.arr[0].map((variant) => {
                            return (
                                <div className="mr-12" key={variant}>
                                    ...
                                    <p className="text-purple-700 text-3xl" style={{fontFamily: [selectedFont.family, 'serif'], fontWeight: variant, fontStyle: 'normal'}}>{selectedFont.family}</p>
                                </div>
                            )
                        })}
                    </div>
                    ...
                    <div className="flex flex-wrap justify-start">
                        {selectedFont.arr[1].length !== 0 && selectedFont.arr[1].map((variant) => {
                            return (
                                <div className="mr-12" key={variant}>
                                    <h4 className="text-2xl">{variant}</h4>
                                    <p className="text-purple-700 text-3xl" style={{fontFamily: [selectedFont.family, 'serif'], fontWeight: variant, fontStyle: 'italic'}}>{selectedFont.family}</p>
                                </div>
                            )
                        })}
                    </div>
            ...
            <section className="flex flex-col-reverse md:flex-row items-center justify-center">
                ...
                <Link to="/serif"><ButtonPrimary>Generate another</ButtonPrimary></Link>
