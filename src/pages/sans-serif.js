...
import SansSerifJson from "../assets/sans-serif.json"
...
const SansSerifPage = () => {
    const selectedFont = SansSerifJson.items[Math.floor(Math.random() * SansSerifJson.items.length)]
    selectedFont['string', 'arr'] = buildFontAndArrayString(selectedFont)

    return (
    <Layout>
        <link rel="preconnect" href="https://fonts.gstatic.com"></link>
        <link href={selectedFont.string} rel="stylesheet"></link>
